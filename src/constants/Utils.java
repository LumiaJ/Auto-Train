...
public class Utils {
	...
	public static final int FRAME_HEIGHT = 400;		//窗口的高度
	...
	public static final int[] SIZE_Y = {0,40,80,120,160,200};	//每一行的Y坐标
	
	public static final String[] SJBH_MENU = {"百分比范围(%)","已知量的最小值","已知量的最大值"};
